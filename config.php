...
try {
    ...
    // REPARO DE METAS: Adiciona completed_at
    try { $pdo->query("SELECT completed_at FROM goals LIMIT 1"); } catch (Exception $e) { $pdo->exec("ALTER TABLE goals ADD COLUMN completed_at DATETIME DEFAULT NULL"); }
