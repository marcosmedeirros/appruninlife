...
try {
    ...
    $tables = [
        ...
        "CREATE TABLE IF NOT EXISTS goals (id INT AUTO_INCREMENT PRIMARY KEY, user_id INT DEFAULT 1, title VARCHAR(255), difficulty ENUM('facil','media','dificil') DEFAULT 'media', status TINYINT DEFAULT 0, goal_type ENUM('geral','anual') DEFAULT 'geral', completed_at DATETIME DEFAULT NULL)",
