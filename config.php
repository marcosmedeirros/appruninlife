...
try {
    ...
    $tables = [
        ...
        "CREATE TABLE IF NOT EXISTS monthly_rules (id INT AUTO_INCREMENT PRIMARY KEY, user_id INT DEFAULT 1, rule_text TEXT NOT NULL, is_active TINYINT DEFAULT 1, created_at DATETIME DEFAULT CURRENT_TIMESTAMP)",
